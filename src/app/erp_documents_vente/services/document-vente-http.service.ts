...
export class DocumentVenteHttpService {
  // Http Header
  constructor(private httpClient: HttpClient, private tokenService:TokenService) {}

  //Get all objects
  GetAll(uriDoc:string = "/bonlivraison", idClient?:string, req?:any, bloque?:Boolean): Observable<any> {
    let data:any = {
    ...
    if(isObjectIdMongoose(idClient)) data['client'] = idClient
  ...
  // Add
  AddNew(data: any, uriDoc:string = "/bonlivraison"): Observable<any> {
  ...
  // Get single object
  GetDetails(id:string, uriDoc:string = "/bonlivraison"): Observable<any> {
    let data:any = {}
  ...
  //update
  update(data: any, uriDoc:string = "/bonlivraison"): Observable<any> {
  ...
  //Delete
  delete(item: DocumentVente, uriDoc:string = "/bonlivraison"): Observable<any> {
  ...
  getData(items:any) {
    ...
    //   newItems.push(new DocumentVente(items[key]))
    // }
    return items
  }
}
