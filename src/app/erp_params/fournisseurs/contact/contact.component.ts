...
import { Contact } from '../../clients/models/contact.model';
...
export class ContactComponent {
  ...
  createProduct() {
    this.dialog
      .open(ContactModalComponent, {
        data: {defaults:new Contact(), fournisseur:this.fournisseur}
      })
      .afterClosed()
  ...
  updateProduct(product: Contact) {
    this.dialog
      .open(ContactModalComponent, {
        data: {defaults:product, fournisseur:this.fournisseur}
        //width: '100vw',
      })
      .afterClosed()
