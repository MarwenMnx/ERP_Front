...
@Component({
  selector: 'vex-ligne-document-correction-stock',
  templateUrl: './ligne-document-correction-stock.component.html',
  styleUrls: ['./ligne-document-correction-stock.component.scss'],
  standalone: true,
...
export class LigneDocumenCorrectionStockComponent {
