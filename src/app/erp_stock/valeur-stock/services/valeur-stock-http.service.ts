...
import {Valeur_stock , ReponseList} from "../models/valeur-stock";
...
export class ValeurStockHttpService {
  REST_API = environment.baseUrl+'/valeur_stock';
  ...
  getData(items:any) {
    ...
    for (let key of Object.keys(items)){
      newItems.push(new Valeur_stock(items[key]))
    }
    return items
  }
