...
export class GouvernoratHttpService {

  REST_API = environment.baseUrl+'/gouvernorat';
  // Http Header
  constructor(private httpClient: HttpClient, private tokenService:TokenService) {
  }
  AddNew(data: Gouvernorat): Observable<any> {
 ...
 // Update
  update(data: Gouvernorat): Observable<any> {
    let newdata:any = data
    newdata.code_societe = this.tokenService.getCodeSociete()
