...
import { ListeLigneDocumentSortiesComponent } from '../liste-ligne-document-sorties/liste-ligne-document-sorties.component';
import { DocumentEnteeSorties, LigneDocumentEntreeSorties } from '../../entreeSortie/entresortie.model';


@Component({
  selector: 'vex-ligne-document-sorties',
  templateUrl: './ligne-document-sorties.component.html',
  styleUrls: ['./ligne-document-sorties.component.scss'],
  standalone: true,
...
export class LigneDocumenSortiesComponent {
...
if (this.form.contains(newValue[0])) {
  ...
  if(!newValue[1]){
    ...
    this.form.patchValue(this.ligneDocumentSortiesService.changeReadonlyBettweenQte1AndQte2(true, this.form.value))
    this.changeTotals()
  }
}
InputNumberChangeObservibalService.submitChangeInput()
  ...
  changeQuantite1(){
    this.form.patchValue(this.ligneDocumentSortiesService.changeQuantite1(this.form.value))
    this.changeTotals()
    this.checkQuantite()
  }
  
  changeQuantite2(){
    this.form.patchValue(this.ligneDocumentSortiesService.changeQuantite2(this.form.value))
    this.changeTotals()
    this.checkQuantite()
  }
