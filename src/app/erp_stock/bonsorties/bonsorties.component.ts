...
import { DocumentSorties } from './models/bonsorties.model';
import {DocumentEnteeSorties} from "../entreeSortie/entresortie.model";


@Component({
  selector: 'vex-bonsorties',
  templateUrl: './bonsorties.component.html',
  styleUrls: ['./bonsorties.component.scss'],
...
export class BonsortiesComponent  {
  ...
  createProduct() {
    this.router.navigate(["bonSorties/new"]);
  }

  updateProduct(product: DocumentEnteeSorties) {
    this.router.navigate(["bonSorties/edit/"+product._id]);
  }
