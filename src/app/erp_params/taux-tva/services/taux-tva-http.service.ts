...
export class TauxTvaHttpService {

  REST_API = environment.baseUrl+'/tauxtva';

  // Http Header
  constructor(private httpClient: HttpClient, private tokenService:TokenService) {
  }
  // Add
  AddNew(data: Tauxtva): Observable<any> {
  ...
  // Update
  update(data: Tauxtva): Observable<any> {
    let newdata:any = data
    newdata.code_societe = this.tokenService.getCodeSociete()
  ...
  getData(items:any) {
    ...
    //   newItems.push(new Tauxtva(items[key]))
    // }
    return items
  }
}
