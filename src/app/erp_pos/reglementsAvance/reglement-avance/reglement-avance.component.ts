...
import {DemoDialogComponent, set_ModePayement} from "../../caisse/caisse.component";
...
@Component({
  selector: 'vex-reglement-avance',
  templateUrl: './reglement-avance.component.html',
  styleUrls: ['./reglement-avance.component.scss'],
  standalone: true,
...
export class ReglementAvanceComponent {
  ...
  changeModeReglement(event:any) {
    this.getDetailsPanier.typePayment = event.source.value
  }
