...
export class PlanComponent {
  ...
  constructor(private service:PlanServiceService, private serviceHttp:PlanHttpServiceService, private dialog: MatDialog, private router:Router) {}
  ...
  ngOnInit() {
    ...
    this.data$.pipe(filter<Plan[]>(Boolean)).subscribe((listItems) => {
  ...
  create() {
    this.dialog
    .open(PlanCreateUpdateComponent, {})
    .afterClosed()
    .subscribe((item: Plan) => {
      if (item) {
        this.listItems.unshift(new Plan(item));
  ...
  update(item: Plan) {
    ...
    .subscribe((updatedItem) => {
      if (updatedItem) {
        ...
        this.listItems[index] = new Plan(updatedItem);
        this.subject$.next(this.listItems);
      }
    });
  }
