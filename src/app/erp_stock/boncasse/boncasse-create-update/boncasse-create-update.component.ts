...
import { BonCasseService } from '../services/boncasse.service';
...
@Component({
  selector: 'vex-boncasse-create-update',
  templateUrl: './boncasse-create-update.component.html',
  styleUrls: ['./boncasse-create-update.component.scss'],
  standalone: true,
...
export class BonCasseCreateUpdateComponent {
  ...
  public defaults: DocumentCasse = new DocumentCasse(null)
  ...
  constructor(
    ...
    private service:BonCasseService,
...
ngOnInit() {
  ...
  if(this.isCreateMode()) {
    ...
    this.defaults.depotpv = this.tokenService.pointVenteCourante
    let set_listDP = ["depotpv",this.tokenService.pointVenteCourante]
  ...
  createProduct() {
    ...
    console.log("************5555555item55**********",item)
