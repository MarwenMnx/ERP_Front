...
export class SoustypevehiculeHttpService {

  REST_API = environment.baseUrl+'/soustypevehicule';
  // Http Header
  constructor(private httpClient: HttpClient, private tokenService:TokenService) {
  }
  AddNew(data: SousTypeVehicule): Observable<any> {
 ...
 // Update
  update(data: SousTypeVehicule): Observable<any> {
    let newdata:any = data
    newdata.code_societe = this.tokenService.getCodeSociete()
