...
export class LigneDocumentCasseService {
...
changeQuantite2(ligne:any){
  ...
  return ligne
    ...
    checkQuantiteIsValide(documentOriginal:DocumentCasse | DocumentCorrectionStock, lignes:LigneDocumentCasse[], allArticles:ArticleDepotPvs[], newLigne?:LigneDocumentCasse, ligneOfList?:LigneDocumentCasse){
    ...
    checkAllLigne(documentOriginal:DocumentCasse | DocumentCorrectionStock, lignes:LigneDocumentCasse[], allArticles:ArticleDepotPvs[]){
    ...
    getLastNumero(lignes:LigneDocumentCasse[]){
      try{
