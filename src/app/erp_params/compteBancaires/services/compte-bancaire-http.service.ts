...
export class CompteBancaireHttpService {

  REST_API = environment.baseUrl+'/compteBancaire';
  // Http Header
  constructor(private httpClient: HttpClient, private tokenService:TokenService) {
  }
  AddNew(data: CompteBancaires): Observable<any> {
 ...
 // Update
  update(data: CompteBancaires): Observable<any> {
    let newdata:any = data
    newdata.code_societe = this.tokenService.getCodeSociete()
