...
export class CategoriesComponent {
  ...
  constructor(private service:CategorieService, private serviceHttp:CategorieHttpService, private dialog: MatDialog, private router:Router) {}
  ...
  create() {
    ...
    .afterClosed()
    .subscribe((item: Categorie) => {
      if (item) {
        this.listItems.unshift(new Categorie(item));
        this.subject$.next(this.listItems);
      }
    });
  }

  update(item: Categorie) {
    this.dialog
    .open(CategorieCreateUpdateComponent, {
      data: item,
    })
    ...
    .subscribe((updatedItem) => {
      if (updatedItem) {
        ...
        this.listItems[index] = new Categorie(updatedItem);
        this.subject$.next(this.listItems);
      }
    });
  }
  ...
  deleteItems(listItems: Categorie[]) {
    /**
