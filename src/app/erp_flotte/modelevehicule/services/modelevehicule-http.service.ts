...
export class ModelevehiculeHttpService {

  REST_API = environment.baseUrl+'/modelevehicule';
  // Http Header
  constructor(private httpClient: HttpClient, private tokenService:TokenService) {
  }
  AddNew(data: ModèleVehicule): Observable<any> {
 ...
 // Update
  update(data: ModèleVehicule): Observable<any> {
    let newdata:any = data
    newdata.code_societe = this.tokenService.getCodeSociete()
