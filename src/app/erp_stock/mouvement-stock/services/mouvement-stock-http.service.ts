...
import {Mouvement_stock, ReponseList} from "../models/mouvement-stock";

@Injectable({
  providedIn: 'root'
})
export class MouvementStockHttpService {

  REST_API = environment.baseUrl+'/mouvement_stock';
  ...
  getData(items:any) {
    ...
    //   newItems.push(new Mouvement_stock(items[key]))
    // }
    return items
  }
