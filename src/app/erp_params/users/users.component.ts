...
export class UsersComponent {
  ...
  columns: TableColumn<User>[] = [
    ...
    //   property: 'codeForgotPassword',
    //   type: 'text',
    //   visible: true,
    //   cssClasses: ['font-medium']
    // },
 /*   {
      label: 'POSSÉDE CAISSE',
      property: 'possedeCaisse',
      type: 'text',
      visible: true,
      cssClasses: ['font-medium']
    },
  ...
  constructor(private service:UsersService, private serviceHttp:UsersHttpService,
              private dialog: MatDialog, private router:Router ,private tokenService:TokenService) {}
  ...
  ngOnInit() {
    ...
    this.serviceHttp.usersBySociete(dataUs).subscribe((res) => {
    ...
    this.data$.pipe(filter<User[]>(Boolean)).subscribe((listItems) => {
  ...
  create() {
    ...
    .subscribe((item: User) => {
      if (item) {
        this.listItems.unshift(new User(item));
  ...
  update(item: User) {
    ...
    .subscribe((updatedItem) => {
      if (updatedItem) {
        ...
        this.listItems[index] = new User(updatedItem);
        this.subject$.next(this.listItems);
      }
    });
  }
