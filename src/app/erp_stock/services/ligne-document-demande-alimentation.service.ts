...
export class LigneDocumentDemandeAlimentationService {
...
changeQuantite2(ligne:any){
  ...
  return ligne
    ...
    checkQuantiteIsValide(documentOriginal:DocumentCasse, lignes:LigneDocumentCasse[], allArticles:ArticleDepotPvs[], newLigne?:LigneDocumentCasse, ligneOfList?:LigneDocumentCasse){
    ...
    checkAllLigne(documentOriginal:DocumentCasse, lignes:LigneDocumentCasse[], allArticles:ArticleDepotPvs[]){
